...
export default function SearchModal({ isOpen, onClose, onSelectResult }) {
  const { sports: SPORTS_LIST, executiveBody: EXECUTIVE_BODY, rules: RULES_CONSTITUTION } = useConvexState();
  ...
  const hasResults = matchingSports.length > 0 || matchingGov.length > 0 || matchingRules.length > 0;
