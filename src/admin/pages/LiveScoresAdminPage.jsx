...
import { Activity, Plus, Play, Pause, CheckCircle2, Save, X } from 'lucide-react';

export default function LiveScoresAdminPage() {
  const { fixtures, updateFixtureScore, addFixture } = useConvexState();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {fixtures.map((fix) => (
          <div key={fix.id} className="p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] space-y-4 shadow-sm">
